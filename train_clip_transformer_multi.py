...
# --- Paths ---
data_root = "wlasl_clip_features_multi"
checkpoint_dir = "wlasl_clip_transformer_multi_checkpoints"
epochs = 10
batch_size = 4
learning_rate = 1e-4
seq_len = 10
...
class_to_idx = full_dataset.class_to_idx  # Save the label->index map

# Apply the same class_to_idx mapping to both splits
